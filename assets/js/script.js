...
var mainPronunciationContainer = document.getElementById(
  "main-pronunciation-container"
);
var mainPronunciationHover = document.getElementById(
  "main-pronunciation-hover"
);
var mainFrequencyContainer = document.getElementById(
  "main-frequency-container"
);
var mainSyllablesContainer = document.getElementById(
  "main-syllables-container"
);
var mainDefinition = document.getElementById("definition-main");
var mainDefinitionsContainer = document.getElementById(
...
var modalWord;
var modalPronunciationContainer = document.getElementById(
  "modal-pronunciation-container"
);
var modalPronunciationHover = document.getElementById(
  "modal-pronunciation-hover"
);
var modalSyllablesContainer = document.getElementById(
  "modal-syllables-container"
);
var modalFrequencyContainer = document.getElementById(
  "modal-frequency-container"
);

var modalDefinition = document.getElementById("definition-modal");
var modalDefinitionsContainer = document.getElementById(
  "modal-definitions-container"
);
  ...
  fetch(wordsAPIUrl, options)
    ...
    .then((data) => {
      ...
      if (frequency === undefined) {
        ...
        mainFrequencyContainer.innerHTML =
          "<u> <strong>Frequency:</strong></u> " + frequency;
      }
    })
    .catch((err) => {
      console.error(err);
      document.getElementById("main-frequency-container").innerHTML =
        "No frequency found";
    });
}
  ...
  fetch(wordsAPIUrl, options)
    ...
    .then((data) => {
      ...
      if (syllables === undefined) {
        ...
        mainSyllablesContainer.innerHTML =
          "<u> <strong>Syllables:</strong></u> " + syllables;
      }
    })
    .catch((err) => {
      console.error(err);
      document.getElementById("main-syllables-container").innerHTML =
        "No syllables found";
    });
}
...
function getModalDefinition() {
  ...
  fetch(wordsAPIUrl, options)
    ...
    .then((data) => {
      if (data !== undefined) {
        modalTitleTextEl.textContent =
          modalWord[0].toUpperCase() + modalWord.slice(1).toLowerCase();
        ...
        if (data.results !== undefined) {
          for (var i = 0; i < data.results.length; i++) {
            ...
            modDefEl.textContent =
              i + 1 + ". " + data.results[i].definition + ";";
...
function getModalSyllables() {
  ...
  fetch(wordsAPIUrl, options)
    ...
    .then((data) => {
      ...
      if (syllables === undefined) {
        document.getElementById("modal-syllables-container").innerHTML =
          "No syllables found";
      } else {
        document.getElementById("modal-syllables-container").innerHTML =
          " <strong>Syllables:</strong> " + syllables;
      }
    })
    .catch((err) => {
      console.error(err);
...
function getModalFrequency() {
  ...
  fetch(wordsAPIUrl, options)
    ...
    .then((data) => {
      ...
      if (frequency === undefined) {
        document.getElementById("modal-frequency-container").innerHTML =
          "No frequency found";
      } else {
        // underline 'Frequency' in main word container
        document.getElementById("modal-frequency-container").innerHTML =
